...
### ❌ Проблема:
Видеоплеер не работает через внешний URL (https://smart-cam-system.preview.emergentagent.com) из-за проблемы с Kubernetes ingress - API запросы `/api/*` не достигают backend сервиса.
...
curl https://smart-cam-system.preview.emergentagent.com/api/recordings
...
Приложение: https://smart-cam-system.preview.emergentagent.com
...
1. После настройки ingress откройте: https://smart-cam-system.preview.emergentagent.com/recordings
