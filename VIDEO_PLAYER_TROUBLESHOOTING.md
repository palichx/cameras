...
### ❌ Проблема:
Видеоплеер не работает через внешний URL (https://videosecureai.preview.emergentagent.com) из-за проблемы с Kubernetes ingress - API запросы `/api/*` не достигают backend сервиса.
...
curl https://videosecureai.preview.emergentagent.com/api/recordings
...
Приложение: https://videosecureai.preview.emergentagent.com
...
1. После настройки ingress откройте: https://videosecureai.preview.emergentagent.com/recordings
