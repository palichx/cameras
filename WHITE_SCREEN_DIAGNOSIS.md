...
```bash
curl https://smart-cam-system.preview.emergentagent.com/api/cameras
...
```bash
curl https://smart-cam-system.preview.emergentagent.com/
...
URL: https://smart-cam-system.preview.emergentagent.com
...
https://smart-cam-system.preview.emergentagent.com
...
watch -n 5 'curl -s https://smart-cam-system.preview.emergentagent.com/api/cameras | head -c 100'
```
