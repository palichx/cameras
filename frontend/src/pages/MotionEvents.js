  ...
  return (
    <div className="space-y-6" data-testid="motion-events-page">
      ...
      <Dialog open={showDateRangeDialog} onOpenChange={setShowDateRangeDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Удаление событий по дате</DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="text-sm text-slate-600">
              {selectedCamera !== 'all' && (
                <p>Будут удалены события только с выбранной камеры</p>
              )}
              {selectedCamera === 'all' && (
                <p>Будут удалены события со всех камер в указанном диапазоне</p>
              )}
            </div>
          </div>
